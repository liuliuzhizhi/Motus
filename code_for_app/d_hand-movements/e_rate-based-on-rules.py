...
============================================================
后端使用方式:
    from e_rate_based_on_rules import score_finger_tapping
...
if __name__ == "__main__":
    import json
    DEBUG_FEATURES_JSON = r"F:\Chinese Excluded Files\Research\Clinical\develop\code\debug_for_app\c_hand-movements\d_rate\debug_features.json"
    DEBUG_OUTPUT_JSON = r"F:\Chinese Excluded Files\Research\Clinical\develop\code\debug_for_app\c_hand-movements\d_rate\debug_score_based-on-rules.json"
    left_or_right = "left"
    ...
    print(f"\n[DEBUG] 打分 (normal_rate={NORMAL_RATE})")
    result = score_finger_tapping(features, normal_rate=NORMAL_RATE)
    print("[DEBUG] 结果:")
